...
const TshirtModal = ({
  ...
  const tshirtImageUrl = 'https://images.unsplash.com/photo-1576566588028-4147f3842f27?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1774&q=80';
  return <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg max-w-lg w-full max-h-[90vh] overflow-auto">
        ...
        <div className="p-6">
          <img src={tshirtImageUrl} alt="Tournament jersey design" className="w-full h-auto rounded-md" />
